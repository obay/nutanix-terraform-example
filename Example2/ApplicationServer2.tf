resource "nutanix_virtual_machine" "windows_2019_server2" {
  name                 = "Windows Server 2019 - Example 2 Server 2"
...
output "Server2IPAddress" {
  value     = nutanix_virtual_machine.windows_2019_server2.nic_list_status.0.ip_endpoint_list[0]["ip"]
  sensitive = false
}